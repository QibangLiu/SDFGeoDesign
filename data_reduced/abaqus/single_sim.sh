...
python_script="/work/hdd/bdsy/qibang/repository_Wbdsy/SDFGeoDesign/data_reduced/abaqus/abaqus_script_sim.py"
...
working_dir="/work/nvme/bbka/qibang/repository_WNbbka/TRAINING_DATA/Geo2DReduced/abaqus/mesh_convg_sample_0"
cd "$working_dir"
/projects/bbkg/Abaqus/2024/Commands/abaqus cae -noGUI $python_script
